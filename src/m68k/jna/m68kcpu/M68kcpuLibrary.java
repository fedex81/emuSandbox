...
public class M68kcpuLibrary {
	 ...
	 */
	public static void m68k_set_bus_read_callback(Pointer<M68K_BUS_READ > readFn) {
	 ...
	 */
	public static void m68k_set_bus_write_callback(Pointer<M68K_BUS_WRITE > writeFn) {
	 ...
	 * <i>native declaration : m68k.h:229</i>
	 */
	public static void m68k_set_int_ack_callback(Pointer<m68k_set_int_ack_callback_callback_callback > callback) {
	 ...
	 * <i>native declaration : m68k.h:238</i>
	 */
	public static void m68k_set_bkpt_ack_callback(Pointer<m68k_set_bkpt_ack_callback_callback_callback > callback) {
	 ...
	 * <i>native declaration : m68k.h:246</i>
	 */
	public static void m68k_set_reset_instr_callback(Pointer<m68k_set_reset_instr_callback_callback_callback > callback) {
	 ...
	 * <i>native declaration : m68k.h:255</i>
	 */
	public static void m68k_set_pc_changed_callback(Pointer<m68k_set_pc_changed_callback_callback_callback > callback) {
	 ...
	 * <i>native declaration : m68k.h:262</i>
	 */
	public static void m68k_set_tas_instr_callback(Pointer<m68k_set_tas_instr_callback_callback_callback > callback) {
	 ...
	 * <i>native declaration : m68k.h:270</i>
	 */
	public static void m68k_set_illg_instr_callback(Pointer<m68k_set_illg_instr_callback_callback_callback > callback) {
	 ...
	 * <i>native declaration : m68k.h:279</i>
	 */
	public static void m68k_set_fc_callback(Pointer<m68k_set_fc_callback_callback_callback > callback) {
	 ...
	 * <i>native declaration : m68k.h:288</i>
	 */
	public static void m68k_set_instr_hook_callback(Pointer<m68k_set_instr_hook_callback_callback_callback > callback) {
	 ...
	 */
	public static int m68k_get_reg(Pointer<? > context, IntValuedEnum<m68k_register_t > reg) {
	 ...
	 */
	public static void m68k_set_reg(IntValuedEnum<m68k_register_t > reg, int value) {
	...
	@Array({1}) 
	public jmp_buf m68ki_bus_error_jmp_buf() {
		try {
			return (jmp_buf)BridJ.getNativeLibrary("m68kcpu").getSymbolPointer("m68ki_bus_error_jmp_buf").as(jmp_buf.class).get();
		}catch (Throwable $ex$) {
			throw new RuntimeException($ex$);
		}
	}
