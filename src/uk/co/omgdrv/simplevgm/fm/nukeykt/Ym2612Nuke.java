...
public class Ym2612Nuke implements MdFmProvider {
    ...
    public static final boolean USE_JNA = Boolean.valueOf(System.getProperty("nuke.use.jna", "false"));

    public Ym2612Nuke() {
        if(USE_JNA){
            initJnaImpl(new Ym3438Jna());
        } else {
            initJavaImpl(new IYm3438.IYm3438_Type());
        }
    }
    ...
    private void initJnaImpl(IYm3438 impl){
        this.ym3438 = impl;
        this.ym3438.OPN2_SetChipType(IYm3438.ym3438_mode_readmode);
    }

    private void initJavaImpl(IYm3438.IYm3438_Type chip){
