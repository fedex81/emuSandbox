...
static void fpgen_rm_reg(uint16 w2)
{
	...
	if (rm)
	{
		switch (src)
		{
			...
			case 4:		// Word Integer
			{
				...
				source = int32o_floatx80((sint32)d);
				break;
			}
			...
			case 7:		// FMOVECR load from constant ROM
			{
				switch (w2 & 0x7f)
				{
					...
					case 0xf:	// 0.0
						source = int32o_floatx80((sint32)0);
						break;
					...
					case 0x32:	// 1 (or 100?  manuals are unclear, but 1 would make more sense)
						source = int32o_floatx80((sint32)1);
						break;

					case 0x33:	// 10^1
						source = int32o_floatx80((sint32)10);
						break;

					case 0x34:	// 10^2
						source = int32o_floatx80((sint32)10*10);
						break;
	...
	switch (opmode)
	{
		...
		case 0x01:		// Fsint
		{
			...
			REG_FP[dst] = int32o_floatx80(temp);
			break;
		}
		case 0x03:		// FsintRZ
		{
